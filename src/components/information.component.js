        ...
        return (
            <div className="content-inner d-flex flex-column">
                ...
                <div className="mt-2 border border-dark">
                    ...
                    <p className="float-left">Loans are financial products that allow individuals or businesses to borrow money from a lender, which is typically a bank or financial institution, to be repaid with interest over a predetermined period. Loans can be used for various purposes, including purchasing a home, financing a car, funding education, or expanding a business.</p>
                </div>
